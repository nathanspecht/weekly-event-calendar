...
var Event = function (_Component) {
  ...
  _createClass(Event, [{
    ...
    value: function render() {
      ...
      var fromTodayPixelCount = -1 * (0, _util.getPixelCount)((0, _moment2.default)().isSameOrBefore(event.rangeStart) ? (0, _moment2.default)() : (0, _moment2.default)(event.rangeStart), (0, _moment2.default)(event.rangeStart));
