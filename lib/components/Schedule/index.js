        ...
        function (_ref) {
          ...
          var yearOptions = (0, _ramda.times)(_ramda.identity, 2).map(function (idx) {
            ...
            return {
              ...
              key: year,
              text: year,
              disabled: (0, _moment2.default)(currentDate).year(year).isAfter((0, _moment2.default)().endOf('month').add(1, 'year')) || (0, _moment2.default)(currentDate).year(year).isBefore((0, _moment2.default)().startOf('day'))
            };
          });
