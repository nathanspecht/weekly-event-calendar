...
var Events = function (_Component) {
  ...
  function Events(props) {
    ...
    _this.cellRenderer = function (_ref) {
      ...
      var events = _this.state.predictedEvents || _this.props.events;
      var _ids = sortedIds(events);
      var _id = _ids[index];
      if (!_id) {
    ...
    _this.cellSizeAndPositionGetter = function (events) {
      var maxRow = _ramda2.default.reduce(_ramda2.default.max, 0, _ramda2.default.map(_ramda2.default.prop('row'), (0, _ramda.values)((0, _assignRows2.default)(events))));
  ...
  _createClass(Events, [{
    ...
    value: function render() {
      ...
      var events = this.state.predictedEvents || this.props.events;
