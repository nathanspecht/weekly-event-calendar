...
var _generateEvents = require('./generate-events');

var _generateEvents2 = _interopRequireDefault(_generateEvents);
...
var HEIGHT = (0, _ramda.values)(_generateEvents2.default).length * 75 + 10;
...
var Events = function (_Component) {
    ...
    _this.handleStop = function (index) {
      return function (extend) {
        return function (_, drag) {
          ...
          var nextEvents = (0, _assignRows2.default)(_extends({}, _this.state.events, _defineProperty({}, _id, _extends({}, event, {
          ...
          _this.setState({ events: nextEvents, isDragging: false });
  ...
  _createClass(Events, [{
    ...
    value: function componentDidMount() {
      this.setState({ events: (0, _assignRows2.default)(_generateEvents2.default) });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var cellCount = (0, _ramda.values)(this.state.events).length + this.state.extraCells + 2;
      var cellSizeAndPositionGetter = this.cellSizeAndPositionGetter(this.state.events);
