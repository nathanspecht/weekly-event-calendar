    ...
    _this.handleStop = function (extend) {
      return function (_, drag, event) {
        ...
        var nextEvents = (0, _assignRows2.default)({
          events: _extends({}, _this.props.events, _defineProperty({}, event.id, updatedEvent))
        });
