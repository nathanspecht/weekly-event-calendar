  ...
  function DaysEvents(props) {
    ...
    _this.componentWillReceiveProps = function (nextProps) {
      if (typeof nextProps.scrollLeft === 'number') {
        var numDays = Math.ceil((nextProps.scrollLeft + 2000) / 216);
        _this.setState({ numDays: numDays }, function () {
    ...
    _this.cellRenderer = function (_ref) {
      ...
      var eventCount = _this.eventsCellCount();
      if (index >= eventCount) {
        return _this.weekDayCellRenderer({ key: key, style: style, index: index - eventCount });
      }
      var events = _this.props.events;
      var _ids = sortedIds(events);
      var _id = _ids[index];
    ...
    _this.cellSizeAndPositionGetter = function (events) {
      ...
      return function (_ref2) {
        ...
        var eventCount = _this.eventsCellCount();
        if (index >= eventCount) {
          return _this.weekDayCellSizeAndPositionGetter({
    ...
    _this.updatePhantomElement = function (_ref3) {
      ...
      if (scrollLeft + 1512 >= scrollWidth) {
        var numDays = Math.ceil((scrollWidth + 1512) / 216);
        _this.setState({
    ...
    _this.weekDayCellRenderer = function (_ref4) {
      ...
      return _react2.default.createElement(
        'div',
        {
          style: _extends({}, style, { zIndex: -1 }),
          key: day + ' ' + index,
          className: 'br b--light-gray top-0 h-100'
        },
        _react2.default.createElement(
          'div',
          { className: 'bg-white w-100 tc pa2 bb b--light-gray' },
          day
        )
      );
    };
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_reactVirtualized.Collection, {
          onScroll: function onScroll(args) {
            ...
            _this3.updatePhantomElement(args);
          },
