...
var Event = function (_Component) {
  ...
  function Event(props) {
    ...
    _this.handleStart = function (extendDir) {
      return function () {
        _this.props.handleStart(_this.props.event.id);
  ...
  _createClass(Event, [{
    ...
    value: function render() {
      ...
      var eventOffset = Math.max(0, scrollLeft - style.left);
      var textOffset = eventOffset + 50 > width ? 0 : eventOffset;
      ...
      var moveToTop = function moveToTop() {
        return _this2.props.moveToTop(event.id);
      };
